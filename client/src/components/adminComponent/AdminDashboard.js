...
import { allSongFetchApi, allUsersSongFetchApi, deleteSongByIdApi } from "../../utils/api";
  ...
  return (
     <>
      <Modal open={open} onClose={()=>dialogClose()}>
        <div className="font-bold bg-white text-xl">
              ...
              >
                <div className="flex">
                  ...
                  <div className="flex flex-col justify-start">
                    <div className="font-semibold text-xl text-gray-300 ml-5 hover:underline">
                      {song.name}
                    </div>
                    <div className="font-semibold text-xl text-gray-300 ml-5 hover:underline">
                      {song.artist.name}
